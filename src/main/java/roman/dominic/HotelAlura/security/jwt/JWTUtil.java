package roman.dominic.HotelAlura.security.jwt;
...
public class JWTUtil {
    @Value("${jwt.secret}") // Esto se debe configurar en tu archivo application.properties o application.yml
    private String jwtSecret;

    @Value("${jwt.expiration}") // Esto se debe configurar en tu archivo application.properties o application.yml
    ...
    public String generateAccessToken(String username){
        return Jwts.builder()
                ...
                .setExpiration(new Date(System.currentTimeMillis() + Long.parseLong(jwtExpiration))) //La fecha de expiracion
